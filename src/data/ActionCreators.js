...
export const loadData = (dataType, params) => ( {
    ...
    payload: dataSource.GetData(dataType, params).then(response => 
        ({dataType : dataType, data: response.data, total: Number(response.headers["x-total-count"]), params}))
});

export const setPageSize = (newSize) =>
({ type: ActionTypes.DATA_SET_PAGESIZE, payload: newSize});

export const setSortProperty = (newSortproperty) =>
({ type: ActionTypes.DATA_SET_SORTPROPERTY, payload: newSortproperty});
